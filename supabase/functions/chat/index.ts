    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { 
            role: "system", 
            content: `You are a friendly and helpful AI assistant for Lumière, an upscale French-inspired restaurant. 

Your role is to:
- Answer questions about our menu, including dishes, ingredients, and dietary accommodations
- Help with reservations and provide information about our hours and location
